...
# of the sidebar.
html_logo = os.path.abspath('./_static/img/autobot.png')

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = os.path.abspath('./_static/img/autobot.png')
...
html_theme_options = {
    "external_links": [],
    "github_url": "https://github.com/laegsgaardTroels/powertools",
}
